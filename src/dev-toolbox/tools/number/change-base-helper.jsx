...
export default function ChangeBaseHelper() {
    ...
    return <>
        ...
        <InputField id="inputBase2" fieldLabel={"Number in base 2 (binary):"} onChange={e => changeInput(e, 2)} value={base2}/>
        <InputField id="inputBase8" fieldLabel={"Number in base 8 (octal):"} onChange={e => changeInput(e, 8)} value={base8}/>
        <InputField id="inputBase10" fieldLabel={"Number in base 10 (decimal):"} onChange={e => changeInput(e, 10)} value={base10}/>
        <InputField id="inputBase16" fieldLabel={"Number in base 16 (hexadecimal):"} onChange={e => changeInput(e, 16)} value={base16}/>
        <InputField id="inputBase36" fieldLabel={"Number in base 36:"} onChange={e => changeInput(e, 36)} value={base36}/>
    </>
}

function InputField(props) {
    return <section className="tool-section">
        <label htmlFor={props.id} className="field-label">{props.fieldLabel}</label>
        <input
            id={props.id}
            className="field"
            value={props.value}
