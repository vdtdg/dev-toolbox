					...
					<div className="radio-selection">
						...
						<label className="radio-selection-grouping">
							...
							<input
								...
								onChange={(e) => setSpecificMinute(parseInt(e.target.value, 10))}
							/>
						</label>
						<label className="radio-selection-grouping">
							<div>
						...
						<label className="radio-selection-grouping">
							...
							<div>
								<input
									...
									onChange={(e) => setRangeMinuteFrom(parseInt(e.target.value, 10))}
								/>
								to
								<input
									type="number"
									...
									max="59"
									value={rangeMinuteTo}
									onChange={(e) => setRangeMinuteTo(parseInt(e.target.value, 10))}
								/>
							</div>
						</label>
					</div>
						...
						<label className="radio-selection-grouping">
							...
							<div>
								<input
									...
									max="23"
									value={rangeHourFrom}
									onChange={(e) => setRangeHourFrom(parseInt(e.target.value, 10))}
								/>
								to
								<input
									type="number"
						...
						<label className="radio-selection-grouping">
							...
							<div>
								<input
									...
									onChange={(e) => setRangeMonthFrom(parseInt(e.target.value, 10))}
								/>
								to
								<input
									type="number"
									...
									max="12"
									value={rangeMonthTo}
									onChange={(e) => setRangeMonthTo(parseInt(e.target.value, 10))}
								/>
							</div>
						</label>
					</div>
