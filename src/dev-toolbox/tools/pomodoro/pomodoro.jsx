...
export default function Pomodoro() {
    ...
    }, [isRunning, mode, sessionCount, sessionLength, shortBreakLength, longBreakLength, currentSession])
    ...
    return <section className="tool-section">
        ...
        <div className="action-button-group">
            {isRunning ? null :
                <button className="button primary-button action-button"
                        onClick={() => setIsRunning(!isRunning)}>
                    Start
                </button>
            }
            <button className="button secondary-button action-button"
                    onClick={reset}>
                Reset
            </button>
        </div>
        ...
        <div className="bottom-warning">
            ⚠️ Switching to another tool will reset your timer. If you want to use another tool, select it in the list and Right Click ➜ Open in
            another tab.
        </div>
    </section>
}
